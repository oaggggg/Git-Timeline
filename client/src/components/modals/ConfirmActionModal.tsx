            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-2.5 w-full mt-6">
                <button
                  ...
                  disabled={isLoading}
                  onClick={onCancel}
                  className="flex-1 py-2 rounded-full border border-slate-200 dark:border-[#30363d] text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-[#21262d] transition-colors disabled:opacity-50"
                >
                  {cancelLabel}
                </button>
                <motion.button
                  ...
                  disabled={isLoading}
                  onClick={onConfirm}
                  className={`flex-1 py-2 rounded-full text-xs font-semibold shadow-xs transition-colors flex items-center justify-center gap-1.5 ${styles.btnBg} disabled:opacity-50`}
                >
